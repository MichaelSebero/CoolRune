...
# REPO PACKAGES INSTALL
pacman -S --noconfirm --needed --ignore=vlc-git lib32-artix-archlinux-support base-devel flatpak kate librewolf python-pip tmux tealdeer jdownloader2 vulkan-icd-loader lib32-vulkan-icd-loader liferea ksnip kcalc font-manager gwenview gimp gamemode lib32-gamemode fail2ban fail2ban-s6 evince dnscrypt-proxy dnscrypt-proxy-s6 apparmor apparmor-s6 bleachbit blueman bluez-s6 konsole catfish clamav clamav-s6 ark gufw mugshot macchanger networkmanager networkmanager-s6 nm-connection-editor wine-ge-custom wine-mono winetricks ufw-s6 pcmanfm qbittorrent redshift steam lynis sneedacity element-desktop rkhunter paru proton-ge-custom lib32-mesa-tkg-git vulkan-intel protontricks-git appimagelauncher opendoas linux-tkg-pds linux-tkg-pds-headers pamac-nosnap mate-system-monitor lightdm-gtk-greeter-settings downgrade libreoffice pipewire-pulse pipewire-alsa wireplumber wine-gecko rust python-psutil python-dateutil python-pydub python-xlib python-pyaudio python-pipenv usbguard usbguard-s6 hunspell-en_us gtk-engine-murrine vkbasalt lib32-vkbasalt chkrootkit testdisk yay && pacman -Rdd --noconfirm --nodeps vulkan-headers && pacman -S --noconfirm vulkan-headers-tkg-git && pacman -R --noconfirm vkd3d && pacman -S --noconfirm --needed vkd3d-proton-tkg-git python-matplotlib python-tqdm python-pillow python-pydub python-mutagen wget noto-fonts-emoji tk xfce4-panel-profiles poetry &&
...
# REPO PACKAGES INSTALL
pacman -S --noconfirm --needed --ignore=nvidia-390xx-utils,lib32-nvidia-390xx-utils,vlc-git lib32-artix-archlinux-support base-devel flatpak kate librewolf python-pip tmux tealdeer jdownloader2 vulkan-icd-loader lib32-vulkan-icd-loader liferea ksnip kcalc font-manager gwenview gimp gamemode lib32-gamemode fail2ban fail2ban-s6 evince dnscrypt-proxy dnscrypt-proxy-s6 apparmor apparmor-s6 bleachbit blueman bluez-s6 konsole catfish clamav clamav-s6 ark gufw mugshot macchanger networkmanager networkmanager-s6 nm-connection-editor wine-ge-custom wine-mono winetricks ufw-s6 pcmanfm qbittorrent redshift steam lynis sneedacity element-desktop rkhunter paru proton-ge-custom nvidia-dkms nvidia-utils nvidia-utils-s6 lib32-nvidia-utils nvidia-settings protontricks-git appimagelauncher opendoas linux-tkg-pds linux-tkg-pds-headers pamac-nosnap mate-system-monitor lightdm-gtk-greeter-settings downgrade libreoffice pipewire-pulse pipewire-alsa wireplumber wine-gecko rust python-psutil python-dateutil python-pydub python-xlib python-pyaudio python-pipenv usbguard usbguard-s6 hunspell-en_us gtk-engine-murrine vkbasalt lib32-vkbasalt chkrootkit testdisk yay && pacman -Rdd --noconfirm --nodeps vulkan-headers && pacman -S --noconfirm vulkan-headers-tkg-git && pacman -R --noconfirm vkd3d && pacman -S --noconfirm --needed vkd3d-proton-tkg-git python-matplotlib python-tqdm python-pillow python-pydub python-mutagen wget noto-fonts-emoji tk xfce4-panel-profiles poetry &&
