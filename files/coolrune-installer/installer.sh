...
pip install --user --break-system-packages imagehash pyzipper textract sounddevice tinytag eyed3 futures audioread librosa moviepy && rm -rf /usr/lib/python3.12/EXTERNALLY-MANAGED && cd /home/coolrune-files/files/coolrune-packages &&
...
# PYTHON PACKAGES (MODULES NOT AVAILABLE IN REPO)
pip install --user --break-system-packages imagehash pyzipper textract tinytag eyed3 futures audioread librosa moviepy && rm -rf /usr/lib/python3.12/EXTERNALLY-MANAGED && cd /home/coolrune-files/files/coolrune-packages &&
