...
# REPO PACKAGES INSTALL
pacman -S --noconfirm --needed lib32-artix-archlinux-support base-devel flatpak kate librewolf python-pip tmux tealdeer jdownloader2 vulkan-icd-loader lib32-vulkan-icd-loader liferea ksnip gnome-keyring kcalc font-manager gwenview gimp gamemode lib32-gamemode fail2ban fail2ban-s6 evince dnscrypt-proxy dnscrypt-proxy-s6 apparmor apparmor-s6 bleachbit blueman unrar bluez-s6 konsole catfish clamav clamav-s6 ark gufw mugshot macchanger networkmanager networkmanager-s6 nm-connection-editor wine-ge-custom wine-mono winetricks ufw-s6 pcmanfm pavucontrol qbittorrent redshift psensor ntfs-3g steam lynis sneedacity element-desktop rkhunter paru proton-ge-custom lib32-mesa-tkg-git vulkan-intel lib32-vulkan-intel protontricks-git appimagelauncher opendoas linux-tkg-pds linux-tkg-pds-headers pamac-nosnap ksysguard tk lightdm-gtk-greeter-settings downgrade portmidi shellcheck npm libreoffice pipewire-pulse pipewire-alsa wireplumber gparted simplescreenrecorder wine-gecko rust python-psutil python-dateutil python-pydub python-xlib python-pyaudio python-pipenv spice-vdagent find-the-command usbguard usbguard-s6 hunspell-en_us gtk-engine-murrine vkbasalt lib32-vkbasalt chkrootkit testdisk yay vulkan-headers-tkg-git vkd3d-proton-tkg-git &&
...
# REPO PACKAGES INSTALL
pacman -S --noconfirm --needed --ignore=nvidia-390xx-utils,lib32-nvidia-390xx-utils lib32-artix-archlinux-support base-devel flatpak kate librewolf python-pip tmux tealdeer jdownloader2 vulkan-icd-loader lib32-vulkan-icd-loader liferea ksnip gnome-keyring kcalc font-manager gwenview gimp gamemode lib32-gamemode fail2ban fail2ban-s6 evince dnscrypt-proxy dnscrypt-proxy-s6 apparmor apparmor-s6 bleachbit blueman unrar bluez-s6 konsole catfish clamav clamav-s6 ark gufw mugshot macchanger networkmanager networkmanager-s6 nm-connection-editor wine-ge-custom wine-mono winetricks ufw-s6 pcmanfm pavucontrol qbittorrent redshift psensor ntfs-3g steam lynis sneedacity element-desktop rkhunter paru proton-ge-custom nvidia-dkms nvidia-utils nvidia-utils-s6 lib32-nvidia-utils nvidia-settings protontricks-git appimagelauncher opendoas linux-tkg-pds linux-tkg-pds-headers pamac-nosnap ksysguard tk lightdm-gtk-greeter-settings downgrade portmidi shellcheck npm libreoffice pipewire-pulse pipewire-alsa wireplumber gparted simplescreenrecorder wine-gecko rust python-psutil python-dateutil python-pydub python-xlib python-pyaudio python-pipenv spice-vdagent find-the-command usbguard usbguard-s6 hunspell-en_us gtk-engine-murrine vkbasalt lib32-vkbasalt chkrootkit testdisk yay vulkan-headers-tkg-git vkd3d-proton-tkg-git &&
